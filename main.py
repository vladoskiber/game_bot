...
from  config.states import CITIES, GAME, TALK, MAINMENU, GAME2, GAME2DIF, GADALKA
from handlers.start_handler import start
from handlers.game_3_handler import game_2_2, game_2_2start, game_2_2dif
from handlers.gadalka_hadlers import  gadalka_start, gadalka
load_dotenv()
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            MAINMENU: [
                ...
                CallbackQueryHandler(gadalka_start, pattern='^gadalka$')
            ],
            ...
            GADALKA: [MessageHandler(filters.TEXT & ~filters.COMMAND, gadalka),],
